...
## Project Structure
    ...
    ├── testapiautocatalog_113409  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113409`
...
2. Clone this repo and `cd testapiautocatalog_113409`
